...
export const calculators: CalculatorConfig[] = [
  {
    slug: 'bmi-calculator',
    name: { en: 'Real BMI Calculator (Body Mass Index)', es: 'Calculadora Real BMI (IMC)', fr: 'Calculateur Real BMI (IMC)', de: 'Real BMI Rechner (Body Mass Index)', ko: 'Real BMI 계산기 (체질량지수)', hi: 'Real BMI कैलकुलेटर (बॉडी मास इंडेक्स)' },
    title: { en: 'Real BMI Calculator – Free Body Mass Index Calculator', es: 'Calculadora Real BMI – Índice de Masa Corporal Gratis', fr: 'Calculateur Real BMI – Indice de Masse Corporelle Gratuit', de: 'Real BMI Rechner – Kostenloser Body-Mass-Index Rechner', ko: '무료 Real BMI 계산기 – 체질량지수 계산기', hi: 'मुफ़्त Real BMI कैलकुलेटर – बॉडी मास इंडेक्स' },
    description: { en: 'Official Real BMI Calculator. Calculate your Real BMI, Body Mass Index (BMI score), ideal weight, and body fat percentage instantly based on WHO & CDC standards.', es: 'Calculadora oficial de Real BMI y de Índice de Masa Corporal (IMC). Calcula tu IMC real, peso ideal y grasa corporal al instante según las normas OMS y CDC.', fr: 'Calculateur officiel Real BMI et d\'Indice de Masse Corporelle (IMC). Calculez votre IMC réel, poids idéal et taux de graisse selon les normes OMS et CDC.', de: 'Offizieller Real BMI Rechner und Body-Mass-Index Rechner. Berechnen Sie Ihren Real BMI, Idealgewicht und Körperfettanteil sofort nach WHO- und CDC-Standards.', ko: '공식 Real BMI 계산기 및 체질량지수 계산기. WHO 및 CDC 표준에 따라 Real BMI 점수, 이상 체중 및 체지방률을 즉시 계산하세요.', hi: 'आधिकारिक Real BMI कैलकुलेटर और बॉडी मास इंडेक्स कैलकुलेटर। WHO और CDC मानकों के आधार पर अपने Real BMI, आदर्श वजन और वसा का तुरंत अनुमान लगाएं।' },
    inputs: [
  ...
  },
  {
    ...
    description: { en: 'Free TDEE Calculator. Calculate your exact Total Daily Energy Expenditure (TDEE), maintenance calories, resting BMR burn, and daily caloric deficit or surplus goals.', es: 'Calculadora gratuita de TDEE. Calcula tu gasto energético total diario (TDEE), calorías de mantenimiento y quema basal.', fr: 'Calculateur gratuit de TDEE. Calculez votre dépense énergétique totale quotidienne, calories de maintien et BMR.', de: 'Kostenloser TDEE-Rechner. Berechnen Sie Ihren Gesamtenergiebedarf (TDEE), täglichen Kalorienverbrauch und Grundumsatz.', ko: '무료 TDEE 계산기. 일일 총 에너지 소비량(TDEE), 유지 칼로리, 기초대사량(BMR) 및 체중 감량/증량 타겟 수치를 정확하게 계산하세요.', hi: 'मुफ़्त TDEE कैलकुलेटर। अपने सटीक Total Daily Energy Expenditure (TDEE), रखरखाव कैलोरी, बीएमआर और वजन घटाने के लक्ष्यों की गणना करें।' },
    inputs: [
      { id: 'weight', label: L.weight, type: 'number', placeholder: '70' },
      { id: 'height', label: L.height, type: 'number', placeholder: '175' },
      { id: 'age', label: L.age, type: 'number', placeholder: '25' },
  ...
  },
  {
    ...
    description: { en: 'Free Body Fat Calculator. Calculate your exact body fat percentage, fat mass, and lean mass using the official US Navy body fat formula and tape measure technique.', es: 'Calculadora gratuita de grasa corporal. Calcula tu porcentaje de grasa corporal, masa grasa y masa magra con la fórmula oficial de la US Navy.', fr: 'Calculateur gratuit de graisse corporelle. Calculez votre pourcentage de graisse corporelle, masse grasse et masse maigre avec la formule US Navy.', de: 'Kostenloser Körperfett-Rechner. Berechnen Sie Ihren Körperfettanteil, Fettmasse und Muskelmasse präzise mit der offiziellen US Navy Formel.', ko: '무료 체지방 계산기. 미 해군(US Navy) 체지방 공식을 사용하여 체지방률(%), 체지방량, 제지방량을 정확하게 계산하세요.', hi: 'मुफ़्त बॉडी फैट कैलकुलेटर। यूएस नेवी फॉर्मूला का उपयोग करके अपने बॉडी फैट प्रतिशत (%), वसा द्रव्यमान और लीन मास की सटीक गणना करें।' },
    inputs: [
      { id: 'gender', label: L.gender, type: 'select', options: [{ value: 'male', label: L.male }, { value: 'female', label: L.female }] },
      { id: 'height', label: L.height, type: 'number', placeholder: '175' },
