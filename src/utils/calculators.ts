...
export const calculators: CalculatorConfig[] = [
  {
    ...
    title: { en: 'BMI Calculator – Free & Accurate Body Mass Index Calculator', es: 'Calculadora de IMC Gratis – Índice de Masa Corporal', fr: 'Calculateur d\'IMC Gratuit – Indice de Masse Corporelle', de: 'BMI Rechner – Kostenloser Body-Mass-Index Rechner', ko: '무료 BMI 계산기 – 체질량지수 계산기', hi: 'मुफ़्त BMI कैलकुलेटर – बॉडी मास इंडेक्स' },
    description: { en: 'Free Body Mass Index (BMI) Calculator. Calculate your Body Mass Index (BMI), ideal weight, and body fat percentage instantly based on WHO & CDC standards. 100% free & private.', es: 'Calculadora de IMC gratis y precisa. Calcula tu Índice de Masa Corporal (IMC), peso ideal y grasa corporal al instante según las normas de la OMS y CDC.', fr: 'Calculateur d\'IMC gratuit. Calculez votre Indice de Masse Corporelle (IMC), poids idéal et taux de graisse selon l\'OMS et le CDC.', de: 'Kostenloser BMI-Rechner. Berechnen Sie Ihren Body-Mass-Index (BMI), Idealgewicht und Körperfettanteil sofort nach WHO- und CDC-Standards.', ko: '무료 BMI 계산기. WHO 및 CDC 표준에 따라 BMI, 이상 체중 및 체지방률을 즉시 계산하세요.', hi: 'मुफ़्त और सटीक BMI कैलकुलेटर। WHO और CDC मानकों के आधार पर अपने बॉडी मास इंडेक्स (BMI), आदर्श वजन और वसा का तुरंत अनुमान लगाएं।' },
    inputs: [
