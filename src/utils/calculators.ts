...
export const calculators: CalculatorConfig[] = [
  ...
  },
  {
    ...
    title: { en: '3D BMI Calculator & Body Visualizer – Free 3D Body Model & Volume Scaling', es: 'Calculadora de IMC 3D y Visualizador Corporal - Modelo 3D Interactivo', fr: 'Calculateur d\'IMC 3D et Visualiseur Corporel - Modèle 3D Interactif', de: '3D BMI Rechner & Body Visualizer - Kostenloses 3D-Körpermodell', ko: '3D BMI 계산기 & 체형 시각화 도구 (3D Body Visualizer)', hi: '3D बीएमआई कैलकुलेटर और बॉडी विजुअलाइज़र - इंटरएक्टिव 3D मॉडल' },
    description: { en: 'Calculate your BMI and visualize your body in 3D. Interactive 3D BMI Visualizer with Oxford 2.5 power formula scaling (1.3 × weight / height²·⁵) to preview body shape in 3D.', es: 'Calcula tu IMC y visualiza tu cuerpo en 3D con nuestro visualizador corporal 3D interactivo según la fórmula Oxford 2.5.', fr: 'Calculez votre IMC et visualisez votre corps en 3D grâce à notre visualiseur corporel 3D interactif.', de: 'Berechnen Sie Ihren BMI und visualisieren Sie Ihren Körper in 3D mit unserem interaktiven 3D Body Visualizer.', ko: 'BMI를 계산하고 3D로 체형을 시각화하세요. 옥스포드 2.5 공식 기반 대화형 3D 체형 시각화 도구.', hi: 'अपने बीएमआई की गणना करें और 3D बॉडी विजुअलाइज़र के साथ 3D में अपना शरीर देखें।' },
    inputs: [
      { id: 'weight', label: L.weight, type: 'number', placeholder: '70' },
      { id: 'height', label: L.height, type: 'number', placeholder: '175' },
      { id: 'age', label: L.age, type: 'number', placeholder: '25' },
