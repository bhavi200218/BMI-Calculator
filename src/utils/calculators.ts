...
export const calculators: CalculatorConfig[] = [
  {
    slug: 'bmi-calculator',
    name: { en: 'Body Mass Index Calculator (BMI)', es: 'Calculadora de Índice de Masa Corporal (IMC)', fr: 'Calculateur d\'Indice de Masse Corporelle (IMC)', de: 'Body-Mass-Index Rechner (BMI)', ko: '체질량지수 계산기 (BMI)', hi: 'बॉडी मास इंडेक्स कैलकुलेटर (BMI)' },
    title: { en: 'Body Mass Index Calculator – Free & Accurate BMI Calculator', es: 'Calculadora de Índice de Masa Corporal – Calculadora de IMC Gratis', fr: 'Calculateur d\'Indice de Masse Corporelle – Calculateur IMC Gratuit', de: 'Body-Mass-Index Rechner – Kostenloser BMI Rechner', ko: '무료 체질량지수 계산기 – BMI 계산기', hi: 'मुफ़्त बॉडी मास इंडेक्स कैलकुलेटर – BMI Calculator' },
    description: { en: 'Free Body Mass Index Calculator (BMI Calculator). Calculate your exact Body Mass Index (BMI), ideal weight, and body fat percentage instantly based on WHO & CDC clinical standards.', es: 'Calculadora de Índice de Masa Corporal (IMC) gratis y clínica. Calcula tu IMC, peso ideal y grasa corporal al instante según las normas de la OMS y CDC.', fr: 'Calculateur gratuit d\'Indice de Masse Corporelle (IMC). Calculez votre IMC, poids idéal et taux de graisse selon les normes OMS et CDC.', de: 'Kostenloser Body-Mass-Index Rechner (BMI Rechner). Berechnen Sie Ihren BMI, Idealgewicht und Körperfettanteil sofort nach WHO- und CDC-Standards.', ko: '무료 체질량지수 계산기 (BMI 계산기). WHO 및 CDC 표준에 따라 BMI, 이상 체중 및 체지방률을 즉시 계산하세요.', hi: 'मुफ़्त बॉडी मास इंडेक्स कैलकुलेटर (BMI Calculator)। WHO और CDC मानकों के आधार पर अपने BMI, आदर्श वजन और वसा का तुरंत अनुमान लगाएं।' },
    inputs: [
