...
export const calculators: CalculatorConfig[] = [
  ...
  },
  {
    ...
    title: { en: '2.5 Power BMI Formula Calculator – 3D BMI & Oxford Body Visualizer', es: 'Calculadora de Fórmula de IMC de Potencia 2.5 - IMC 3D y Visualizador Corporal', fr: 'Calculateur de Formule d\'IMC de Puissance 2.5 - IMC 3D et Visualiseur Corporel', de: '2.5-Potenz-BMI-Formel-Rechner – 3D-BMI & Körper-Visualisierer', ko: '2.5 제곱 BMI 공식 계산기 - 3D BMI & 체형 시각화 도구', hi: '2.5 पावर बीएमआई फॉर्मूला कैलकुलेटर - 3D बीएमआई और बॉडी विजुअलाइज़र' },
    description: { en: 'Calculate height-adjusted BMI with our 2.5 Power BMI Formula Calculator. Uses Oxford Nick Trefethen 2.5 power equation (1.3 × weight / height²·⁵) & 3D body visualizer.', es: 'Calcula tu IMC ajustado por altura con nuestra calculadora de fórmula de potencia 2.5 según Oxford (1.3 × peso / altura²·⁵) y visualizador 3D.', fr: 'Calculez votre IMC ajusté avec notre calculateur de formule de puissance 2.5 d\'Oxford (1.3 × poids / taille²·⁵).', de: 'Berechnen Sie Ihren höhenbereinigten BMI mit unserem 2.5-Potenz-BMI-Formel-Rechner nach der Oxford-Gleichung.', ko: '2.5 제곱 BMI 공식 계산기로 신장 보정 BMI를 계산하세요. 옥스포드 2.5 공식(1.3 × 체중 / 신장²·⁵) 및 3D 시각화 제공.', hi: '2.5 पावर बीएमआई फॉर्मूला कैलकुलेटर से ऊंचाई-समायोजित बीएमआई की गणना करें। ऑक्सफोर्ड 2.5 पावर फॉर्मूला (1.3 × वजन / ऊंचाई²·⁵) और 3D बॉडी विजुअलाइज़र का उपयोग करें।' },
    inputs: [
      { id: 'weight', label: L.weight, type: 'number', placeholder: '70' },
      { id: 'height', label: L.height, type: 'number', placeholder: '175' },
      { id: 'age', label: L.age, type: 'number', placeholder: '25' },
